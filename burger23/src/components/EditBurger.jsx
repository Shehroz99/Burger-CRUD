...
const EditBurger = () => {
    ...
    return (
        <section className="flex flex-col bg-white font-semibold text-center rounded-3xl border shadow-lg p-10 max-w-xs">
            ...
            <input onClick={saveChanges} type="button" value="Lagre endring" className="peer h-full w-full rounded-md border  px-3 py-3 font-sans text-sm font-normal outline outline-0"/>
        </section>
    )
}
